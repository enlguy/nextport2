...
export default function EmailSection() {
  const [state, handleSubmit] = useForm("mnqenjdq");
  ...
  if (state.succeeded) {
    return (
      <>
        <section
          id="contact"
          className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative mx-3"
        >
          ...
          <div className="z-10">
            ...
            <div className="socials flex flex-row gap-2">
              ...
              <Link href="https://linkedin.com/in/jack-epner" target="_blank">
                <Image
